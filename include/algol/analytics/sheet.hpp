...
namespace analytics {
  ...
  public:
    ...
    typedef std::map<string_t, bool>      boolean_stats_t;
    ...
    /** All boolean stats tracked within this sheet_t (excluding children's). */
    boolean_stats_t  const& boolean_stats() const;
  ...
  protected:
    ...
    sheet_t           *parent_;
    string_t          title_;
    num_stats_t       num_stats_;
    boolean_stats_t   boolean_stats_;
    literal_stats_t   literal_stats_;
  };
