...
#ifndef H_ALGOL_MESSAGING_MESSAGE_H
#define H_ALGOL_MESSAGING_MESSAGE_H
...
namespace algol {
  ...
  public:
    ...
    /**
     * Stamps the message with an ID that indicates to the recipient that
     * this message should be acknowledge with a response. The response message
     * will contain this message ID in the correlation_id field.
     */
    void set_message_id(string_t const&);
